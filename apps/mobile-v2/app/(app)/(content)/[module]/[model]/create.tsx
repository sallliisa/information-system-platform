...
import { CRUDCreate } from '../../../../../src/components/composites/CRUD/CRUDCreate'
...
export default function DynamicCreateRoute() {
  ...
  return (
    <AuthenticatedContent>
      <CRUDCreate config={entry.config} onBack={() => navigateBackOrFallback(router as any, entry.hrefs.list)} />
    </AuthenticatedContent>
  )
}
